...
- $\mu$ is the coefficient of friction (usually $0.4 \lt \mu \lt 0.7$   )

$\sigma_{s}=C+\sigma_{n}\tan \phi =C+$ $\sigma_{n}u$
...
## The experiment, remembered from Module 1.3
...
What exactly is that quantity on the colour bar? That is the next slide — and the numbers that follow are all read straight off this experiment.
...
The experiment where all three cautions bite — the sign of the answer flips fault by fault.
...
![](Module-iii-Theory/Lecture1-extracted/slide035_img1.jpg) <!-- .element style="max-height:400px;" -->
...
<p class="caption">Uniaxial compression · Biaxial compression · $\sigma_{s}=C+\sigma_{n}\tan \phi$</p>
...
$\boldsymbol{\sigma} = \left[ \begin{matrix} \sigma_{xx} & \sigma_{xy} \cr \sigma_{yx} & \sigma_{yy} \end{matrix} \right]$ = $\left[ \begin{matrix} \vec{T}_x \cr \vec{T}_y \end{matrix} \right]$
...
$\vec{T} \cdot \vec{f} = [a \;\; b] \cdot \left[ \begin{matrix} 1 \cr 0 \end{matrix} \right] = a$
...
<p class="caption">$\sigma_{s}=C+\sigma_{n}\tan \phi$</p>
