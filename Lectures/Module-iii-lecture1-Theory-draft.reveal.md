...
$$\sigma_s = \frac{\sigma \sin 2\theta}{2}=\sigma \sin \theta \cos \theta \qquad F_s = F \sin \theta$$

$$\sigma_n = \sigma \cos^2\theta \qquad F_n = F \cos \theta$$
...
$\sigma_v = \sigma_1$: normal-fault regime;
$\sigma_v = \sigma_2$: strike-slip fault regime;
$\sigma_v = \sigma_3$: thrust-fault regime;
