...
<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Fold_related_to_backsliding_of_Caledonian_nappes_Hardanger.jpg" -->
...
<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Folds.jpg" -->
...
![Fold](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Fossen_Chap11_fold_mechanisms.jpg) <!-- .element style="float: right" width="95%" -->
...
![Buckling](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Buckling.jpg) <!-- .element style="float: right" width="90%" -->
...
![Buckling](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation1.gif) <!-- .element style="float: center" width="90%" -->

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Fossen_Chapter11_Buckling.jpg" -->
...
![Buckling Oblique](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation2.gif) <!-- .element style="float: center" width="100%" -->
...
![Fold](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Buckling.svg) <!-- .element style="float: right" width="90%" -->
...
![Buckling Thickness](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation4.gif) <!-- .element style="float: center" width="95%" -->
</div>
</div>
...
![Fold](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Thickness_and_Fold_wavelengths.svg) <!-- .element style="float: right" width="50%" -->
...
![Buckling Viscosity Contrast](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation5.gif) <!-- .element style="float: center" width="90%" -->
...
![Flexural Flow](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/BucklingViscosityContrast.png) <!-- .element style="float: center" width="95%" -->
...
![Buckling Spacing](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation6.gif) <!-- .element style="float: center" width="60%" -->
</div>
</div>
...
![Buckling Folding](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation7.gif) <!-- .element style="float: center" width="95%" -->
</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Multilayers.jpg" -->
...
![Buckling Folding](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation8.gif) <!-- .element style="float: center" width="95%" -->
</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Flexural_Slip_parallel_folds.jpg" -->
...
![Parallel Folds](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Flexural_Slip_parallel_folds.jpg) <!-- .element style="float: center" width="80%" -->

</div>

<div style="width:50%; float:right">

![Flexural Slip](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Flexural_Slip.svg) <!-- .element style="float: center" width="90%" -->
...
Properties are (as for Flexural slip)
...
![Flexural Flow](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation9.gif) <!-- .element style="float: center" width="95%" -->
</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Flexural_Flow_similar_folds.jpg" -->
...
![Similar Folds](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Flexural_Flow_similar_folds.jpg) <!-- .element style="float: center" width="95%" -->

</div>
<div style="width:50%; float:right">

![Flexural Flow](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Flexural_Flow.svg) <!-- .element style="float: center" width="95%" -->
...
![Orthogonal Flexure](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation10.gif) <!-- .element style="float: center" width="95%" -->
</div>
</div>
...
![Orthogonal Flexure](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/OrthogonalFlexureStrainPatterns.png) <!-- .element style="float: center" width="70%" -->
</div>
</div>
...
![Orthogonal Flexure](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/OrthogonalFlexure.png) <!-- .element style="float: center" width="80%" -->
</div>
</div>
...
![Adding Strain](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation11.gif) <!-- .element style="float: center" width="95%" -->
</div>
</div>
...
![Adding Strain](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/InnerArcCollapse.png) <!-- .element style="float: center" width="95%" -->
...
![Space Problem](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation12.gif) <!-- .element style="float: center" width="95%" -->
![Space Problem](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation13.gif) <!-- .element style="float: center" width="95%" -->
...
![Shearing](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Buckling_animation14.gif) <!-- .element style="float: center" width="95%" -->
...
![Passive Folding](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Passive_Folding1.gif) <!-- .element style="float: center" width="95%" -->

</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/SimilarFoldsCaledonides.jpg" -->
...
![Passive Folding](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Passive_Folding2.gif) <!-- .element style="float: center" width="95%" -->
...
![Passive Folding](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Passive_Folding3.gif) <!-- .element style="float: center" width="95%" -->
...
![Bending](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Bending_Examples.jpg) <!-- .element style="float: center" width="90%" -->
...
![Bending](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Monocline.jpg) <!-- .element style="float: center" width="95%" -->
...
![Monocline](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Monocline.gif) <!-- .element style="float: center" width="90%" -->
...
*Example of forced folds in the hanging wall at fault ramp locations*

</div>
<div style="width:50%; float:right">

![Ramps and Folds 1](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/FaultBendFold.gif) <!-- .element style="float: center" width="90%" -->
![Ramps and Folds 2](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/FaultPropFold.gif) <!-- .element style="float: center" width="90%" -->

</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/faultbendfoldphotoredo.jpg" -->

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/drag_fold.jpeg" -->
...
![Diapir](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Diapir.gif) <!-- .element style="float: center" width="90%" -->
...
![Diapir](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Boudinage.gif) <!-- .element style="float: center" width="90%" -->

</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Fossen_Passive_Folds_between_boudins.jpg" -->
...
![Kinking](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/gifs/Kinking.gif) <!-- .element style="float: center" width="90%" -->
...
![Kink Folds](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Kink_Folds.svg) <!-- .element width="50%" -->

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/kink_fold_Bergen.jpg" -->

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/Kink_folds_Oman_cherts.jpg" -->
...
![Interference Patterns](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/FossenInterferencePatternsB.jpg) <!-- .element style="float: center" width="95%" -->
...
![Interference Patterns](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/FossenInterferencePatterns.jpg) <!-- .element style="float: center" width="90%" -->

</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/photos/FossenInterferenceFolds.jpg" -->

<--o-->

## Sheath folds

![Sheath Fold](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Sheath_Folds.svg) <!-- .element style="float: right" width="95%" -->
...
![Fold](Module-v-Ductile-Deformation/Figures-Folds-and-Folding-Mechanisms/figures/Folding_in_extensional_environment.svg) <!-- .element style="float: right" width="95%" -->
