...
![IndoAus](images/GlobalTectonics/IndoAustralianPlate-Forces-Reynolds2003.png) <!-- .element style="float:right; width:45%; margin-left:30px;" -->
...
![IndoAus](images/GlobalTectonics/IndoAustralianPlate-Forces-Reynolds2003.png) <!-- .element style="float:right; width:40%; margin-left:30px;" -->
...
![LAB](images/Australia/australia-lab.png) <!-- .element style="display:block; margin-left:auto; margin-right:auto; width:55%" -->
...
LithoRef18, Afonso et al. (2019), [doi:10.1093/gji/ggz094](https://doi.org/10.1093/gji/ggz094), grid via EarthByte — chosen over LITHO1.0 as the more modern reference model. The native model is 2°; this is a surfaced 0.25° rendering, so read the first-order pattern, not the detail.

→ Seen independently as seismic tomography at 150 km in the [continental accretion lecture](Module-i-Accretion-draft.reveal.html): cool, fast, thick lithosphere under the west and centre; warm, slow, thin under the Tasmanides.

</small>

<--v-->

## Why the mining companies care

The cyan line on that map is the **170 km** contour — the step from thick cratonic lithosphere to thin.

Hoggard et al. (2020) tested this globally: **85% of sediment-hosted base metal deposits, and *every* giant one, lie within 200 km of that step.** The idea is that the edge of a craton is where you get both the deep, long-lived plumbing and the basins to put the metal in.

Australia supplies two of the textbook cases — **Mount Isa** and **Broken Hill** — and both sit on the contour. Check them against the map yourself rather than taking my word for it.

*This is the payoff of the whole deck in one line: the deposits, the province map, the lithospheric structure and the assembly history are all the same story told from different angles.*

<small>

Hoggard, Czarnota, Richards, Huston, Jaques & Ghelichkhan (2020), *Nature Geoscience* **13**, 504–510.
...
![Sediment](images/Australia/australia-sediment.png) <!-- .element style="display:block; margin-left:auto; margin-right:auto; width:55%" -->

- **OZ SEEBASE** and GA basin studies map **depth to basement** — the thickness of the sedimentary cover. **64% of the continent sits under more than a kilometre of it**, and the deepest basins exceed 15 km.
...
OZ SEEBASE 2021, Geognostics Australia, via Geoscience Australia, CC BY 4.0. Log colour scale — thickness spans four orders of magnitude.

</small>

<--v-->

## …which is why we need the X-rays

![Gravity](images/Australia/australia-gravity.png) <!-- .element style="display:block; margin-left:auto; margin-right:auto; width:55%" -->

If most of the geology is buried, you map it with **potential fields**. This is the Bouguer gravity anomaly — density structure, seen straight through the cover.

Note the broad **low over central Australia**: that is the same place the Moho map showed the **thickest crust**. Two completely independent measurements, one answer — thick, low-density crustal root. That agreement is how you know to trust either of them.

<small>

National Gravity Compilation 2019 (complete spherical cap Bouguer anomaly), Geoscience Australia, CC BY 4.0. Magnetics (TMI) is the other half of the pair — see [Module 2.1](Module-ii-Lecture-1-Structural-Geology-And-Crustal-Deformation.reveal.html).
...
<!-- All four of these now have figures built from public data by
     tools/figures/ (gravity, stress, seismicity), except TMI which is
     deliberately linked to Module 2.1 rather than repeated. -->
