...
![Shear Zone](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/BrittleDuctilieTransition.jpg) <!-- .element style="float: right" width="90%" -->
...
![Shear Zone 1](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone2.jpg) <!-- .element style="float: right" width="90%" -->
...
![Shear Zone 2](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone1.jpg) <!-- .element style="float: right" width="70%" -->
...
![Shear Zone continuous discontinuous](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/Shear_Zone.svg) <!-- .element style="float: right" width="90%" -->
...
![Shear Zone 3](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone1.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone1.jpg) <!-- .element style="float: right" width="70%" -->
...
![Granular Flow](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone27.gif) <!-- .element style="float: right" width="90%" -->
...
![Cataclastic Flow](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone28.gif) <!-- .element style="float: right" width="90%" -->
...
![Granular Flow](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone29.gif) <!-- .element style="float: right" width="90%" -->
...
![Shear Zone 2](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZonePRonaEGU.jpg) <!-- .element style="float: right" width="90%" -->
...
![Shear Zone 2](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone22.jpg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/BrittleFaultZone.png) <!-- .element style="float: right" width="90%" -->

</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone18.jpg" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone3.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone9.jpg) <!-- .element style="float: right" width="70%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/ExampleBrittleDuctile.png) <!-- .element style="float: right" width="80%" -->
...
<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone15.jpg" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone2.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone3.jpg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone4.jpg) <!-- .element style="float: right" width="90%" -->

</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/ShearZone5.jpg" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone5.gif) <!-- .element style="float: right" width="70%" -->
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone6.gif) <!-- .element style="float: right" width="70%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone7.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone8.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone10.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone12.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone17.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone18.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone19.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone20.gif) <!-- .element style="float: center" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone21.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone30.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone23.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone24.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone25.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/gifs/ShearZone26.gif) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/Mylonites.jpg) <!-- .element style="float: right" width="90%" -->
...
<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/Mylonites.jpeg" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/KinematicIndicators.jpg) <!-- .element style="float: center" width="100%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/Mylonites_Asymetric_structures.jpg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/Deflection.png) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/SCStructures.jpg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/MicaFish.jpeg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/RotatedBoudinage.jpeg) <!-- .element style="float: right" width="90%" -->

</div>
</div>

<--o-->
<!-- .slide: data-background="Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/RotatedBoudinage.jpeg" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/Wings_shear.svg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Photos/FoldNonCoaxial.jpg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/QuarterStructures.jpg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/QuartzMineralAxis.jpg) <!-- .element style="float: right" width="90%" -->
...
![label](Module-v-Ductile-Deformation/Figures-Shear_zones/Figures/VeinDevelopment.svg) <!-- .element style="float: right" width="90%" -->
