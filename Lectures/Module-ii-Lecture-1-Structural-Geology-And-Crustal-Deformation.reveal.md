...
![](images/External/Lyell.jpg) <!-- .element style="float: right" height="400px" -->
...
Faults and graben structure, offshore Tunisia (Rob Butler, Seismic Atlas https://see-atlas.leeds.ac.uk/)
...
![Plates-USGS](images/External/Plates_tect2_en.svg) <!-- .element style="float:right; width:30%"-->
