...
## Motion Relative to the Mantle

<div class="cols">
<div>

![Hawaiian–Emperor chain](images/GlobalTectonics/HawaiianEmperorChain-bathymetry.jpg)

</div>
<div>

![The Hawaiian hotspot](images/GlobalTectonics/HawaiianHotspot-crossSection.jpg)

</div>
</div>

Point 1 above has one important exception. A hotspot is fed from far below the plates, so a volcanic chain built over one records motion relative to the **mantle** rather than relative to a neighbouring plate.

The Hawaiian Ridge–Emperor Seamount chain is more than 80 volcanoes over some 6,200 km, from the Aleutian Trench to Lōʻihi, and it ages steadily to the north-west: the Pacific Plate has been drawn across a "deep" and "fixed" source. The sharp bend halfway along is a change of *direction*.

So a no-net-rotation frame is a convention, chosen to make the answer convenient. A hotspot track is a measurement.

<small>

Bathymetry: National Geophysical Data Center / USGS. Cross-section: USGS.

</small>

Note:
The scare quotes on "fixed" are doing real work and are worth a sentence
out loud. Hotspots are not rigidly fixed to each other or to the deep
mantle, and how much of the Hawaiian-Emperor bend records a change in
Pacific plate motion versus southward motion of the plume itself is
still argued over. The teaching point survives either way: the track
measures motion of the plate with respect to something that is not
another plate, which is exactly what the relative-motion models cannot
give you.
