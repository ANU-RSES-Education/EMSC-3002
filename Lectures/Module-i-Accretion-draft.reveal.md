...
<!-- The pptx/keynote converter split this slide into five images and
     DROPPED every annotation drawn over them: the "Tasman line" curve and
     its label, the Nuna label, the two highlight ellipses and the
     Tasmanides / North and West Australian Craton arrows. Replaced with
     composed exports of the original slide (Louis, 2026-08-11), which
     carry the annotation. Do not revert to the slide006_img* fragments. -->

![Provinces](images/Australia/tasman-line-provinces.png) <!-- .element style="display:block; margin-left:auto; margin-right:auto; width:38%" -->

Archean / Proterozoic in the Western two thirds of the continent. A collection of more recently accreted fragments to the East, with the **“Tasman line”** between them.

<--v-->

## Two bursts of accretion

![TwoBursts](images/Australia/two-bursts-accretion.png) <!-- .element style="display:block; margin-left:auto; margin-right:auto; width:80%" -->

The U–Pb zircon spectrum puts the growth in **two bursts** — the North and West Australian cratons at ~1900–1700 Ma, and the Tasmanides from ~500 Ma — with the supercontinent intervals shaded. The tomography at 150 km shows the result: cool, fast, thick lithosphere under the west and centre, warm and thin under the Tasmanides.

<p class="caption">Tomography from Fishwick &amp; Rawlinson, 2012</p>

<small>

↩ The provinces, the “Tasman line” and the assembly table are introduced in [Module 1.1a — The Australian Plate](Module-i-GlobalTectonics-1a.reveal.html).
