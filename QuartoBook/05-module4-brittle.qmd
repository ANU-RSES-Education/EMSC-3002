...
- Perpendicular to σ~3~ (minimum principal stress)
- Mode I opening
...
- τ = 0.85σ~n~ (low pressure, <200 MPa)
- τ = 50 + 0.6σ~n~ (high pressure)
- Friction coefficient μ ≈ 0.6-0.85
...
- Moment (M~0~): rigidity × area × slip
- Moment magnitude (M~w~): most reliable scale
