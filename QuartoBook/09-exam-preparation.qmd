...
✓ **Correct:** Faults form at ~30° to σ~1~, not parallel to it
:::
...
✓ **Correct:** Byerlee's Law shows it's remarkably constant (μ ≈ 0.6-0.85)
:::
...
1. **Connect stress to structures:**
   - Normal faulting regime → σ~1~ vertical → normal faults, graben, rifts
...
- **WHY** faults form at 30° to σ~1~ (minimize work)
